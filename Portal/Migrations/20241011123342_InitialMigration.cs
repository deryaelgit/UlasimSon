        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KanGrubuId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_KanGrubus_KanGrubuId1",
                        column: x => x.KanGrubuId1,
                        principalTable: "KanGrubus",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuzergahZamanCizelgeleri", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuzergahZamanCizelgeleri_Guzergahlar_GuzergahId",
                        column: x => x.GuzergahId,
                        principalTable: "Guzergahlar",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuzergahZamanCizelgeleri_LookupLists_GunId",
                        column: x => x.GunId,
                        principalTable: "LookupLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GuzergahZamanCizelgeleri_LookupLists_YerTuruId",
                        column: x => x.YerTuruId,
                        principalTable: "LookupLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GuzergahZamanCizelgeleri_Users_OlusturanKullaniciId",
                        column: x => x.OlusturanKullaniciId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AracSahipleri_AracPlakalari_PlakaId",
                        column: x => x.PlakaId,
                        principalTable: "AracPlakalari",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AracDenetimGecmisiFotolari",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AracDenetimGecmisiFotolari", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AracDenetimGecmisiFotolari_DenetimGecmisleri_DenetimGecmisiId",
                        column: x => x.DenetimGecmisiId,
                        principalTable: "DenetimGecmisleri",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AracDenetimGecmisiFotolari_Fotolar_FotoId",
                        column: x => x.FotoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AracDenetimGecmisiFotolari_DenetimGecmisiId",
                table: "AracDenetimGecmisiFotolari",
                column: "DenetimGecmisiId");

            migrationBuilder.CreateIndex(
                name: "IX_AracDenetimGecmisiFotolari_FotoId",
                table: "AracDenetimGecmisiFotolari",
                column: "FotoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuzergahZamanCizelgeleri_GunId",
                table: "GuzergahZamanCizelgeleri",
                column: "GunId");

            migrationBuilder.CreateIndex(
                name: "IX_GuzergahZamanCizelgeleri_GuzergahId",
                table: "GuzergahZamanCizelgeleri",
                column: "GuzergahId");

            migrationBuilder.CreateIndex(
                name: "IX_GuzergahZamanCizelgeleri_OlusturanKullaniciId",
                table: "GuzergahZamanCizelgeleri",
                column: "OlusturanKullaniciId");

            migrationBuilder.CreateIndex(
                name: "IX_GuzergahZamanCizelgeleri_YerTuruId",
                table: "GuzergahZamanCizelgeleri",
                column: "YerTuruId");

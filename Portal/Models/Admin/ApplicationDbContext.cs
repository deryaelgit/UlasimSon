...
namespace Portal.Models.Admin
{
  ...
  public DbSet<Denetim> Denetimler { get; set; }
        ...
        public DbSet<DenetimGecmisiFoto> AracDenetimGecmisiFotolari { get; set; }
    ...
    public DbSet<DenetimCeza> DenetimCezalari { get; set; } // Denetim ve Ceza ilişkisini tutan tablo
        ...
        // Güzergah ve Zaman Çizelgesi Tabloları
        public DbSet<Guzergah> Guzergahlar { get; set; }
        public DbSet<GuzergahZamanCizelge> GuzergahZamanCizelgeleri { get; set; }
...
modelBuilder.Entity<User>()
    ...
    .WithMany()
    .HasForeignKey(u => u.KanGrubuId)
    .OnDelete(DeleteBehavior.Restrict); // KanGrubu silindiğinde User etkilenmesin
...
modelBuilder.Entity<LookupList>()
 ...
 // User ve Denetim İlişkisi
    ...
    // DenetimCeza ve CezaYonetmelik İlişkisi
    modelBuilder.Entity<DenetimCeza>()
        .HasOne(dc => dc.CezaYonetmelik)
        .WithMany()
        .HasForeignKey(dc => dc.CezaYonetmelikId)
        .OnDelete(DeleteBehavior.Restrict); // CezaYonetmelik silinirse DenetimCeza silinmez

    // DenetimCeza ve Denetim İlişkisi
    modelBuilder.Entity<DenetimCeza>()
        .HasOne(dc => dc.Denetim)
        .WithMany()
        .HasForeignKey(dc => dc.DenetimId)
        .OnDelete(DeleteBehavior.Restrict); // Denetim silinirse DenetimCeza silinmez
 ...
 // DenetimGecmisi ve Denetim İlişkisi
    ...
    // DenetimGecmisiFoto ve DenetimGecmisi İlişkisi
    modelBuilder.Entity<DenetimGecmisiFoto>()
        .HasOne(dgf => dgf.DenetimGecmisi)
        .WithMany(dg => dg.DenetimGecmisiFotolari)
        .HasForeignKey(dgf => dgf.DenetimGecmisiId)
        .OnDelete(DeleteBehavior.Cascade); // Denetim Gecmisi silindiğinde, fotoğraflar da silinsin

    // DenetimGecmisiFoto ve Foto İlişkisi
    modelBuilder.Entity<DenetimGecmisiFoto>()
        .HasOne(dgf => dgf.Foto)
        .WithMany()
        .HasForeignKey(dgf => dgf.FotoId)
        .OnDelete(DeleteBehavior.Cascade); // Foto silindiğinde, Denetim Gecmisi Foto kaydı da silinsin

    // LookupList ve CezaYonetmelik İlişkisi
    modelBuilder.Entity<CezaYonetmelik>()
        .HasOne(cy => cy.PlakaTuru)
    ...
    // Kullanıcı ve LookupList (Cinsiyet) İlişkisi
    modelBuilder.Entity<User>()
        .HasOne(u => u.KanGrubu)
        .WithMany()
        .HasForeignKey(u => u.KanGrubuId)
        .OnDelete(DeleteBehavior.Restrict); // Kan Grubu silindiğinde
    ...
    modelBuilder.Entity<Guzergah>()
        .HasMany(g => g.GuzergahZamanCizelgeleri)
    ...
    modelBuilder.Entity<GuzergahZamanCizelge>()
        .HasOne(z => z.YerTuru)
        .WithMany()
